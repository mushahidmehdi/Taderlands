	...
	var Q,
		...
		ne =
			("undefined" == typeof navigator ||
				("ReactNative" !== (Q = navigator.product) && "NativeScript" !== Q && "NS" !== Q)) &&
				...
				function (t) {
					return (
						ye(t) ||
							...
							t &&
								t.response &&
								((t.response.data = ve.call(e, e.transformResponse, t.response)),
				...
				r(e, [
					{
						...
						value: function (e, t) {
							...
							void 0 !== o &&
								...
								void 0 !== i &&
									Pe.assertOptions(i, { encode: _e.function, serialize: _e.function }, !0),
