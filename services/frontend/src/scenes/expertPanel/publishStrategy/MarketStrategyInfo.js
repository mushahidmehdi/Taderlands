...
export default function MarketStrategyInfo({ strategy, handleRefreshStategies }) {
				...
				<Box component="form" autocomplete="off">
					...
					<FormControl fullWidth margin="normal">
						<TextField
							...
							minRows="6"
							id={"explanations"}
							value={marketStrategy?.explanations?.text}
							onChange={(e) => {
								setMarketStrategy({
									...marketStrategy,
									explanations: {
					...
					{!isFree && (
						<>
							...
							<Grid>
								...
								>
									{t("expert_panel_edit_profile_reset_button")}
								</Typography>
								<Box>
